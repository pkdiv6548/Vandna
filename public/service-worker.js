...
const ASSETS=['./','./index.html','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png','./music/auralis-dawn.wav','./music/auralis-pulse.wav','./music/auralis-night.wav'];
